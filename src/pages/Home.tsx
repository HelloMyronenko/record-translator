...
import { Mic, MicOff, Languages, Volume2, Copy, Download, Loader2, Globe, Headphones, AlertCircle, Info, LogOut, User } from 'lucide-react'
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <header className="text-center mb-12">
          <div className="flex justify-end mb-4">
            <div className="flex items-center gap-4 bg-white/10 backdrop-blur-lg rounded-full px-4 py-2 border border-white/20">
              ...
              <button
                ...
                className="flex items-center gap-2 px-3 py-1 bg-white/10 hover:bg-white/20 rounded-full text-white transition-colors"
              >
          ...
          <p className="text-purple-200 text-lg max-w-2xl mx-auto">
            Chat and Build helps you Chat and Translate!
          </p>
              ...
              <div className="flex items-start gap-2">
                ...
                <div className="text-sm text-blue-200">
                  ...
                  <ul className="text-xs space-y-1">
                    ...
                    <li>• Translation: Lingvanex API with dictionary fallback</li>
                    <li>• Real-time processing and transcription</li>
        ...
        <div className="mt-16 grid md:grid-cols-3 gap-6 max-w-4xl mx-auto">
          ...
          <div className="bg-white/10 backdrop-blur-lg rounded-xl p-6 border border-white/20 text-center">
            ...
            <h3 className="text-lg font-semibold text-white mb-2">Smart Translation</h3>
            <p className="text-purple-200 text-sm">Powered by Lingvanex API</p>
          </div>
        </div>
      </div>
    </div>
